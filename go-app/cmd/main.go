...
func main() {
	...
	staticPaths := []string{"./static", "/Users/niclasedge/GITHUB/go-teuxdeux/static"}
	
	for _, path := range staticPaths {
		if _, err := os.Stat(path); err == nil {
			router.Static("/static", path)
			// Also serve assets from the expected Vite path
	...
	// Web routes - serve the built index.html
	router.GET("/", func(c *gin.Context) {
		// Try multiple paths for index.html
		indexPaths := []string{"./static/dist/index.html", "/app/static/dist/index.html", "/Users/niclasedge/GITHUB/go-teuxdeux/static/dist/index.html"}
